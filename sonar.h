 ...
 */
#define TRIG_DDR    DDRA            // Trigger Port
#define TRIG_PORT   PORTA
#define TRIG_PIN    PINA
#define TRIG_BIT    PA3             // Trigger Pin
 
#define ECHO_DDR    DDRA           // Echo Port
#define ECHO_PORT   PORTA
#define ECHO_PIN    PINA
#define ECHO_BIT    PA4            // Echo Pin
 
// Speed of sound
// Default: 343 meters za sekundu pri 20 stupnov
#define SPEED_OF_SOUND  343
#define MAX_SONAR_RANGE 8         // This is trigger + echo range (in meters) 
...
#define CONVERT_TO_CM ((100000*2)/SPEED_OF_SOUND)    // or simply 583
